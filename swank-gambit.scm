...
;; Not yet implemented
;;
;; (this list was generated semi-automatically, not all of these
;; functions are necessarily required.  The entries were categorized
;; manually, categorization may be off.)

;; Debugger Core

;(swank-define-op swank:backtrace-for-emacs)
;(swank-define-op swank:clear-repl-results)
;(swank-define-op swank:debugger-info-for-emacs)
;(swank-define-op swank:disassemble-symbol)
;(swank-define-op swank:eval-and-grab-output)
;(swank-define-op swank:eval-string-in-frame)
;(swank-define-op swank:redirect-trace-output)
;(swank-define-op swank:safe-backtrace)
;(swank-define-op swank:simple-break)
;(swank-define-op swank:sldb-abort)
;(swank-define-op swank:sldb-break)
;(swank-define-op swank:sldb-break-on-return)
;(swank-define-op swank:sldb-break-with-default-debugger)
;(swank-define-op swank:sldb-continue)
;(swank-define-op swank:sldb-next)
;(swank-define-op swank:sldb-out)
;(swank-define-op swank:sldb-step)
;(swank-define-op swank:slime-debugger-fucntion)
;(swank-define-op swank:swank-toggle-trace)
;(swank-define-op swank:throw-to-toplevel)
;(swank-define-op swank:toggle-debug-on-swank-error)
;(swank-define-op swank:untrace-all)

;; Completion

;(swank-define-op swank:complete-form)
;(swank-define-op swank:completions-for-character)
;(swank-define-op swank:completions-for-keyword)
;(swank-define-op swank:fuzzy-completion-selected)
;(swank-define-op swank:fuzzy-completions)
...
;(swank-define-op swank:describe-symbol)
;(swank-define-op swank:documentation-symbol)
;(swank-define-op swank:find-definition-for-thing)
;(swank-define-op swank:find-definitions-for-emacs)
;(swank-define-op swank:hyperdoc)
;(swank-define-op swank:list-all-package-names)
;(swank-define-op swank:mop)
;(swank-define-op swank:who-depends-on)
;(swank-define-op swank:xref)
;(swank-define-op swank:xrefs)

;; Profiling

;(swank-define-op swank:profile-by-substring)
;(swank-define-op swank:profile-package)
;(swank-define-op swank:profile-report)
;(swank-define-op swank:profile-reset)
;(swank-define-op swank:profiled-functions)
;(swank-define-op swank:swank-sprof-disassemble)
;(swank-define-op swank:swank-sprof-expand-node)
;(swank-define-op swank:swank-sprof-get-call-graph)
;(swank-define-op swank:swank-sprof-source-location)
;(swank-define-op swank:swank-sprof-start)
;(swank-define-op swank:swank-sprof-stop)
;(swank-define-op swank:toggle-profile-fdefinition)
;(swank-define-op swank:unprofile-all)
...
;(swank-define-op swank:create-socket)
;(swank-define-op swank:create-swank-server)
;(swank-define-op swank:default-directory)
;(swank-define-op swank:delete-system-fasls)
;(swank-define-op swank:export-symbol-for-emacs)
;(swank-define-op swank:filename-to-modulename)
;(swank-define-op swank:function-source-location-for-emacs)
;(swank-define-op swank:inspect-current-condition)
;(swank-define-op swank:inspect-for-emacs)
...
;(swank-define-op swank:re-evaluate-defvar)
;(swank-define-op swank:reload-system)
;(swank-define-op swank:set-default-directory)
;(swank-define-op swank:set-package)
;(swank-define-op swank:start-server)
;(swank-define-op swank:startup-multiprocessing)
;(swank-define-op swank:swank-compiler-macroexpand)
;(swank-define-op swank:swank-format-string-expand)
...
;(swank-define-op swank:swank-require)
;(swank-define-op swank:symbol-does-not-exist)
;(swank-define-op swank:undefine-function)
;(swank-define-op swank:unexport-symbol-for-emacs)
;(swank-define-op swank:update-indentation-information)
;(swank-define-op swank:value-for-editing)
;(swank-define-op swank:warn-unimplemented-interfaces)
